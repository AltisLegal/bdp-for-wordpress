...
//echo random_string(50);
	...
	//integreate the html
	$html = new htmlGrab('http://espcdesign.fullscreenstaging.com/wp-content/plugins/bdp-for-wordpress/includes/jetengine/ajax_holder.xml?rand=' . random_string(50),$this);
	//set the header
